...
# --- Initialize Components (Global Scope) ---
print("--- Initializing RAG Agent Components (Global) ---")
...
print("--- All Components Initialized (Global) ---")

# --- Define the Graph (Global Scope) ---
...
# Compile the graph (Global Scope)
